...
@Component({
  ...
  templateUrl: './lista-anime-vose.component.html',
  styleUrl: './lista-anime-vose.component.css'
})

export class ListaAnimeVoseComponent implements AfterViewInit {
  ...
  private obtenerAnimes(): void {
    const url = 'http://localhost:8080/v1/Anime_vose';
